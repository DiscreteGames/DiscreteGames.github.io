...
The goal now is to write some [Python 3](https://www.scaler.com/topics/python/tuples-in-python/) code that actually generates the infinite sequences of n-tuples described above.
